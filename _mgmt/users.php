...
?>
<?php
$page_title = __('users.manage_title');
...
?>
    ...
    <script>
        ...
        function resetSearchPosition() {
            ...
            input.style.width = '';
            input.placeholder = (typeof t === 'function' ? t('search.placeholder_users') : 'Search users... (Drag to column)');
