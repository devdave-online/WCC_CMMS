...
?>
<?php
$page_title = __('analytics.diag_title');
...
<?php include __DIR__ . '/../nav.php'; ?>
    ...
    <div class="dashboard-container">
        <div class="page-header">
            <h2>📈 <?= __e('analytics.diag_heading') ?></h2>
            <div style="display:flex; gap:15px; align-items:center;">
                <span style="color:var(--text-secondary); font-size:0.9em;">Last Calculated: <?= $last_updated ?></span>
                <a href="?run_cron=1&csrf=<?= wcc_csrf_token() ?>" class="btn">🔄 Run Analytics Engine Now</a>
        ...
        <div class="kpi-grid">
            <div class="kpi-card hero-kpi">
                <div>
                    <div class="hero-title">Availability (fleet, last 30 days)</div>
                    <div class="hero-value"><?= number_format($availability, 1) ?>%</div>
                </div>
            </div>
            ...
            <div class="kpi-card">
                <div class="kpi-title">MTTA (Mean Time To Acknowledge)</div>
                <div class="kpi-value"><?= number_format($mtta, 2) ?> <span style="font-size:0.4em;">hrs</span></div>
            </div>
