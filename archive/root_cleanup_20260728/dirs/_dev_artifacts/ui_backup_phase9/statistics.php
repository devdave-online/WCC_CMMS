        ...
        const handleChartClick = (evt, elements, chart, type) => {
            ...
            if (type === 'MTBF') {
                html = `<table class="ledger-table" style="width:100%; border-collapse:collapse; font-size:0.9em; text-align:left;">
                    <thead><tr><th style="padding-bottom:8px;">Week</th><th style="padding-bottom:8px;">Failures</th><th style="padding-bottom:8px;">MTBF (Hours)</th></tr></thead>
                    <tbody>`;
                
                weekly.forEach(w => {
                    html += `<tr>
                        <td style="padding:4px 0;">${w.week}</td>
                        <td style="color:#f87171; font-weight:bold; padding:4px 0;">${w.failures}</td>
                        <td style="padding:4px 0; color:#10b981; font-weight:bold;">${w.mtbf || 0}h</td>
                    </tr>`;
                });
            } else {
                html = `<table class="ledger-table" style="width:100%; border-collapse:collapse; font-size:0.9em; text-align:left;">
                    <thead><tr><th style="padding-bottom:8px;">Week</th><th style="padding-bottom:8px;">Failures</th><th style="padding-bottom:8px;">MTTD</th><th style="padding-bottom:8px;">MTTR</th><th style="padding-bottom:8px;">MDT</th></tr></thead>
                    <tbody>`;
...
<div id="weeklyModal" style="display:none; z-index: 100000; position: fixed; background: rgba(15, 23, 42, 0.97); color: #e0e7ff; padding: 14px 16px; border-radius: 8px; font-size: 0.82em; width: 320px; height: auto; box-shadow: 0 15px 40px rgba(0,0,0,0.5); border: 1px solid #38bdf8; text-align: left;">
