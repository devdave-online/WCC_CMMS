...
<div class="dashboard-container">
    <div class="page-header" style="margin-bottom:10px;">
        <h2>?? Vendor Vault Configuration</h2>
        <div style="display:flex; gap:10px; align-items:center;">
            ...
            <button class="btn" onclick="openModal()">+ Add Vendor</button>
        </div>
    </div>
            ...
            <tbody>
                ...
                <tr class="parent-row" data-id="<?= $i['vendor_id'] ?>">
                    ...
                    <td style="display: flex; gap: 5px;">
                        <button type="button" class="nav-btn" style="padding:4px 10px; font-size:0.8em; background:#ca8a04; border:none; color:white; border-radius:4px; cursor:pointer;" 
                        ...
                        <form id="vendorForm_<?= htmlspecialchars($i['vendor_id']) ?>" method="POST" style="margin:0;">
                            ...
                            <button type="button" onclick="openWccConfirm('Are you sure you want to delete this vendor?', function() { document.getElementById('vendorForm_<?= htmlspecialchars($i['vendor_id']) ?>').submit(); }, 'Delete Vendor');" class="nav-btn" style="padding:4px 10px; font-size:0.8em; background:#ef4444; border:none; color:white; border-radius:4px; cursor:pointer;">Delete</button>
                        </form>
                    </td>
                </tr>
...
<div id="setupModal" class="modal">
  <div class="modal-content" style="padding: 30px; box-shadow: 0 20px 40px rgba(0,0,0,0.5);">
    ...
    <form method="POST">
        ...
        <button type="submit" class="nav-btn primary" style="width:100%; font-size:1.1em; padding:12px;">Save Vendor Configuration</button>
    </form>
  </div>
</div>
</body>
