...
<div class="auth-container">
    <div style="text-align: center; margin-bottom: 20px;">
        <h1 style="color: var(--text-accent); margin:0; font-size: 2.5em;">🔒 Action Required</h1>
        <p class="text-muted" style="margin-top: 6px;">You must change your password before continuing.</p>
    </div>
    ...
    <form method="POST" action="change_password.php">
        ...
        <button type="submit" class="btn btn-primary btn-block" style="font-size:1.05em; padding:12px;">Update Password</button>
    </form>
</div>
