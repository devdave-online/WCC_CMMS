...
?>
<?php
$page_title = __('vendors.mgmt_title');
    ...
    <script>
        ...
        function dropSearch(ev, thElement) {
            ...
            if (query !== '') {
                ...
                input.placeholder = (typeof t === 'function' ? t('search.type_lock') : 'Type & click 📌 to Lock');
        ...
        function resetSearchPosition() {
            ...
            input.style.width = '';
            input.placeholder = (typeof t === 'function' ? t('search.placeholder_vendors') : 'Search vendors... (Drag to column. Dbl-Click Reset)');
...
<div class="dashboard-container">
    <div class="page-header" style="margin-bottom:10px;">
        <h1>🏢 <?= __e('vendors.config_title') ?></h1>
            ...
            <div id="searchWrapper">
                <div id="searchContainerOrig" style="display:inline-block; position:relative; width:100%;" draggable="true" ondragstart="dragSearch(event)">
                    <span style="position:absolute; left:12px; top:50%; transform:translateY(-50%); color:var(--text-secondary); pointer-events:none; font-size:1.1em;">🔍</span>
                        <input type="text" id="ledgerSearch" onkeyup="handleSearchInput(event)" placeholder="<?= __e('search.placeholder_vendors') ?>" 
...
<div id="setupModal" class="modal">
  <div class="modal-content" style="padding: 30px; box-shadow: 0 20px 40px rgba(0,0,0,0.5);">
    ...
    <h2 id="modalTitle" style="color: var(--text-primary);"><?= __e('vendors.register') ?></h2>
